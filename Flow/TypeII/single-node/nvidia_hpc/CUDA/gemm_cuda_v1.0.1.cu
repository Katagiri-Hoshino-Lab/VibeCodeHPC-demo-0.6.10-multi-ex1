// GEMM (General Matrix Multiplication) CUDA実装 v1.0.1
// C = alpha * A * B + beta * C
...
int main(int argc, char* argv[]) {
    ...
    printf("# GEMM CUDA Implementation v1.0.1\n");
    printf("# Matrix dimensions: M=%d, N=%d, K=%d\n", M, N, K);
    printf("# Data type: double precision (64-bit)\n");
    printf("# Block size: %d x %d (tuned for V100)\n", BLOCK_SIZE, BLOCK_SIZE);
    ...
    // V100理論性能に対する効率
    double v100_peak_dp = 7800.0; // GFLOPS for double precision
